...
class DeepseekV4Model(nn.Module, EagleModelMixin):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        from vllm.models.deepseek_v4.tp_pad import apply_config_tp_pad

        apply_config_tp_pad(config, get_tensor_model_parallel_world_size())
        self.config = config
